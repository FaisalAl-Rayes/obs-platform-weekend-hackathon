...
Custom Tekton Tasks and Pipelines for team-beta components.
...
```yaml
annotations:
  pipelinesascode.tekton.dev/task: "http://gitea-http.gitea.svc:3000/team-beta/pipelines/raw/branch/main/tasks/custom-build.yaml"
```
